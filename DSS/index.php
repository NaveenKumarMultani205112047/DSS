...
session_start();
 ...
 if(isset($_SESSION['ok'])) echo '<h2><font color="#00FF66">Welcome  '.$_SESSION['uname'].'</font>&nbsp;&nbsp;&nbsp;<a href="register/logout.php">Logout</a></h2>';
 else header("location:register/login.php")
...
<head>
<title>Document Sharing System</title>
<link rel="shortcut icon" href="/favicon.ico">
